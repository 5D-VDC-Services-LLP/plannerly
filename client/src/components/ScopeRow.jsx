...
//     }
//     
//     // Non-editable row types (Folder, Parameter Group)
...
//           {/* Controls (Add/Delete) - Only visible in edit mode */}
//           {mode === 'edit' && (
...
  const [showMenu, setShowMenu] = useState(false);
  const menuRef = useRef(null);
  const buttonRef = useRef(null); // Reference for the button position
...
        ref={menuRef} 
        style={style}
        className="w-48 bg-white border border-gray-200 rounded shadow-lg"
      >
        {item.type === 'folder' && <>
          <button onClick={() => handleAddItem('folder')} className="w-full text-left px-3 py-1.5 text-sm hover:bg-gray-100">Add Folder</button>
          <button onClick={() => handleAddItem('element')} className="w-full text-left px-3 py-1.5 text-sm hover:bg-gray-100">Add Element</button>
...
                    ref={buttonRef} // Attach the button reference here
                  >
                    <Plus size={14} />
                  </button>
                </div>
